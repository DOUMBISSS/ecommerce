...
export default function House () {
    ...
    const [groups, setGroups] = useState(['Electroménager','Maison & Déco']);
    const [selectedCategories, setSelectedCategories] = useState([]);
    const [selectedBrands, setSelectedBrands] = useState([]);
    const [selectedGroup, setSelectedGroup] = useState('Electroménager'); // Default to "Électronique"
    ...
    useEffect(() => {
        fetch('https://back-fodex-ecommerce.onrender.com/products')
            ...
            .then(items => {
                const filteredItems = items.filter(item => item.groupe === 'Electroménager' || item.groupe === 'Maison & Déco');
